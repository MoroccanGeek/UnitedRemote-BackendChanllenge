...
REST microservices that list the languages used by the 100 trending public repos on GitHub
...
For deploying, i've used Docker. It's not 100% working (It was an honorable defeat against docker :D). I've created for each microservice app an executable JARs and a Docker image.

To run all containers, please move to folder "config-server" and type the below command:
...
Link: https://streamable.com/he2ah
